      ...
      <React.Fragment>
        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            <ListGroup className="list-group-accent" tag={'div'}>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                ...
                <div><strong>Operator Level 1</strong> update a profile </div>
                <small className="text-muted mr-3">
                  <i className="icon-people"></i>&nbsp; Operator 1
                </small>
                <small className="text-muted">
                  <i className="icon-calendar"></i> 04.00 pm
                </small>
              </ListGroupItem>
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                <div className="avatar float-right">
                ...
                <div><strong>Operator Level 1</strong> added a <strong>Paket Perjalanan</strong>  </div>
                <small className="text-muted mr-3">
                  <i className="icon-people"></i>&nbsp; Operator 1
                </small>
                <small className="text-muted">
                  <i className="icon-calendar"></i> 04.30 pm
                </small>
              </ListGroupItem>
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-success list-group-item-divider">
                <div><strong>198 User Pengguna</strong> active</div>
                <small className="text-muted mr-3">
                  <i className="icon-people"></i>&nbsp; UMUM
                </small>
              </ListGroupItem>
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-danger list-group-item-divider">
                <div><strong>34 User Pengelola</strong> active </div>
                <small className="text-muted mr-3">
                  <i className="icon-people"></i>&nbsp; CORPORATE
                </small>
              </ListGroupItem>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                ...
                <small className="text-muted">
                  <i className="icon-calendar"></i> 02.39 pm
                </small>
              </ListGroupItem>
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-success list-group-item-divider">
                <div><strong>198 User Pengguna</strong> active</div>
          ...
          <div className="message">
              ...
              <div className="text-truncate font-weight-bold">Admin System</div>
            ...
            <div className="message">
              ...
              <div>
                <small className="text-muted">Operator 1</small>
              </div>
              <div className="text-truncate font-weight-bold">Operator Level 1</div>
              <small className="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                tempor incididunt...
              </small>
            </div>
          ...
          <TabPane tabId="3" className="p-3">
            ...
            <div className="aside-options">
              ...
              <div>
                <small className="text-muted">Detail about this
                </small>
              </div>
            </div>
